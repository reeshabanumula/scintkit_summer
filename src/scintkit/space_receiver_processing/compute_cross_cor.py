...
import numpy as np
import importlib
from cross_cor import cross_correlation
...
# import pqs
dfa = pd.read_parquet(
    r'C:\Users\irees\Downloads\Summer_learning\research26\Brazil_22_lvl0\scintpi3_20221004_2000_359060.7812W_72122.4141S_v325_lvl0.pq'
)

dfb = pd.read_parquet(
    r'C:\Users\irees\Downloads\Summer_learning\research26\Brazil_22_lvl0\scintpi3_20221004_2000_359072.7500W_72126.9375S_v325_lvl0.pq'
)
...
for (svid, cons), sat_group in sat_groups:
    ...
    for min, group in min_groups:
        ...
        if s4a > thresh or s4b > thresh:
            ...
            correlation, lag_b, cor_norm, lag_norm = cross_correlation(
                group["snr1_A"],
                group["snr1_B"]
            )
